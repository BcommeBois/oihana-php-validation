...
class GreaterThanRuleTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->validator->addRule('gt_field', new GreaterThanRule());
    }
    ...
    public function testFailsWhenValueIsEqualToComparisonField(): void
    {
        $data = [
    ...
    public function testWorksWithFloatValues(): void
    {
        ...
        $validation = $this->validator->validate($data, [
            'value1' => 'required|gt_field:value2',
        ]);
    ...
    public function testFailsWithNullValue(): void
    {
        ...
        $validation = $this->validator->validate($data, [
            'value1' => 'present|gt_field:value2',
        ]);
    ...
    public function testHasCorrectErrorMessage(): void
    {
        ...
        $validation = $this->validator->validate($data, [
            'value1' => 'required|integer|gt_field:value2',
        ]);
    ...
    public function testFailsWhenValueIsEqualToFixedValue(): void
    {
        $data = [
            'timeout' => 600,
        ];
